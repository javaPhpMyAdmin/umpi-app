...
export const mockListings: Listing[] = [
  ...
  {
    id: 'l6', user_id: 'u6', category_id: '7', title: 'Café especialidad - Barista', description: 'Cafes de especialidad de origen unico. Metodos: V60, Chemex, Aeropress.', price: null, price_type: 'contact', location: 'Córdoba', images: ['https://images.pexels.com/photos/302899/pexels-photo-302899.jpeg'], is_featured: false, listing_priority: 0, status: 'active', rating: 4.6, reviews_count: 15, created_at: '2024-12-05',
  ...
  {
    id: 'l8', user_id: 'u8', category_id: '3', title: 'Toyota Hilux 4x4 2023', description: 'Doble cabina, 25.000 km. Impecable. Accesorios originales.', price: 28500000, price_type: 'fixed', location: 'Salta', images: ['https://images.pexels.com/photos/1149137/pexels-photo-1149137.jpeg'], is_featured: true, listing_priority: 3, status: 'active', rating: 5.0, reviews_count: 2, created_at: '2024-11-28',
  ...
  {
    id: 'l12', user_id: 'u12', category_id: '6', title: 'Sushi Bar - 2x1 martes', description: 'Sushi fresco y creativo. Promociones todos los dias.', price: null, price_type: 'contact', location: 'Córdoba', images: ['https://images.pexels.com/photos/1267320/pexels-photo-1267320.jpeg'], is_featured: false, listing_priority: 0, status: 'active', rating: 4.6, reviews_count: 22, created_at: '2024-11-10',
