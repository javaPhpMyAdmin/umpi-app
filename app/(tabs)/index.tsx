...
export default function HomeScreen() {
  ...
  const quickCategories = useMemo(
    () =>
      categories.filter(
        (cat) => cat.slug !== 'todos' && cat.slug !== 'destacados'
      ),
    [categories]
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <View
        style={[
          styles.header,
          { marginTop: insets.top, paddingTop: 40, paddingBottom: 40 },
        ]}
      >
      ...
      {loadingListings && listings.length === 0 ? (
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.featuredRow}>
                {[1, 2, 3].map((i) => (
                  <SkeletonCard key={i} variant="featured" />
                ))}
              </View>
            </ScrollView>
          </View>
        ...
        //SHOWS BANNER IF THERE ARE NO FEATURED LISTINGS
        <ScrollView
          showsVerticalScrollIndicator={false}
          contentContainerStyle={styles.scrollContent}
        >
          ...
          {featured.length > 0 && (
            <View style={styles.section}>
              <View style={styles.sectionHeader}>
                ...
                {featured.length >= 6 && (
                  <TouchableOpacity
                    onPress={() => router.push({ pathname: '/featured' })}
                  >
